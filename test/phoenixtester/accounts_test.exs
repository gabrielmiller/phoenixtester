defmodule Phoenixtester.AccountsTest do
  use Phoenixtester.DataCase

  alias Phoenixtester.Accounts

  import Phoenixtester.AccountsFixtures
  alias Phoenixtester.Accounts.{User, UserToken}
  ...
  describe "organizations" do
    ...
    @invalid_attrs %{domain: nil, title: nil}
    ...
    test "create_organization/1 with valid data creates a organization" do
      valid_attrs = %{domain: "some domain", title: "some title"}
    ...
    test "update_organization/2 with valid data updates the organization" do
      organization = organization_fixture()
      update_attrs = %{domain: "some updated domain", title: "some updated title"}
